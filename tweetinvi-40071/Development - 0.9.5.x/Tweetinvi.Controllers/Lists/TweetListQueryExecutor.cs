...
namespace Tweetinvi.Controllers.Lists
{
    ...
    {
        IEnumerable<ITweetListDTO> GetUserLists(IUserIdentifier userDTO, bool getOwnedListsFirst);
    ...
    public class TweetListQueryExecutor : ITweetListQueryExecutor
    {
        ...
        // Get User Lists
        public IEnumerable<ITweetListDTO> GetUserLists(IUserIdentifier userDTO, bool getOwnedListsFirst)
        {
        ...
        public IEnumerable<IUserDTO> GetMembersOfList(IListIdentifier identifier, int maxNumberOfUsersToRetrieve)
        {
            ...
            return _twitterAccessor.ExecuteCursorGETQuery<IUserDTO, IUserCursorQueryResultDTO>(query, maxNumberOfUsersToRetrieve);
        }
    }
}