...
namespace Tweetinvi.Logic
{
    ...
    public class Tweet : ITweet
    {
        ...
        public ITweetEntities ExtendedEntities
        {
            get { return _tweetDTO.ExtendedEntities; }
        }
        ...
        public List<IMediaEntity> Media
        {
            get
            {
                ...
                {
                    return ExtendedEntities.Medias;
                }
        ...
        public int Length
        {
            get
            {
                ...
                if (_tweetDTO.IsTweetPublished && _tweetDTO.Entities != null && _tweetDTO.Entities.Medias != null && _tweetDTO.Entities.Medias.Any())
                {
                    mediaTweetLength = MEDIA_CONTENT_SIZE;
                }
        ...
        public void AddMedia(byte[] data)
        {
            if (IsTweetPublished)
            {
                throw new Exception("Cannot add media after the tweet has been published!");
            }
        ...
        public override string ToString()
        {
            return String.Format("'{0}', {1}, '{2}', '{3}', '{4}', '{5}'",
                Id, CreatedAt, Creator.Name, Text, Creator.Language, TweetLocalCreationDate);
        }
