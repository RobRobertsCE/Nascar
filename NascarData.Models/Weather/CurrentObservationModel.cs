...
namespace NascarApi.Models.Weather
{
    public class CurrentObservationModel
    {
        ...
        public DisplayLocationModel display_location { get; set; }
        public ObservationLocationModel observation_location { get; set; }
        public EstimatedModel estimated { get; set; }
